...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Pruebas vinculadas a la infección por VIH</title>
<meta name="keywords" content="test de vih Sida, Sida, VIH, vih antígeno" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'test-de-VIH-sida';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>PRUEBAS VINCUALDAS A LA INFECCIÓN POR VIH</h1>
									<span class="prueba">VIH ANTÍGENO / ANTICUERPO ANTI DETERMINACIÓN EN SUERO</span>
								</div>
								<img src="images/resources/landings/HIV.jpg" alt="test vih-Sida" title="test vih-Sida">
							</div><!-- single post image -->
							<p>El VIH o Virus de la Inmunodeficiencia Humana es un microorganismo que ataca al Sistema Inmune de las personas, debilitándolo y haciéndoles vulnerables ante una serie de infecciones, algunas de las cuáles pueden poner en peligro la vida. </p>
							<p>El Síndrome de la Inmunodeficiencia Adquirida o Sida es el estado de la infección por el VIH caracterizado por bajos niveles de defensas y la aparición de infecciones oportunistas.</p>
							<p>Realizamos el estudio de detección del antígeno p24 y de Anticuerpos anti virus del VIH por metodología de quimioluminiscencia en plataforma Architect – ABBOTT.</br>Se extrae una muestra de sangre del paciente en ayunas y en 60 minutos le devolvemos el resultado.</p>
							<div class="post-avatar" style="margin-top:20px;">
								<div class="news-detail" style="padding-bottom:0">
									<h1>PRUEBAS VINCUALDAS A LA INFECCIÓN POR VIH</h1>
									<span class="prueba">VIH CARGA VIRAL DETERMINACIÓN EN SANGRE</span>
								</div>
							</div><!-- single post image -->
							<p>Realizamos el estudio de la carga viral de HIV todos los jueves en plataforma totalmente automatizada sp2000 real Time - ABBOTT.</p>
							<p>El resultado lo devolvemos el día viernes.</p>
							<p><strong>Información de interés:</strong></br>
								<a href="https://www.cdc.gov/hiv/spanish/basics/whatishiv.html" target="blank">Acerca del VIH/Sida</a>
							</p>
							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el test de VIH-Sida</p>
								</div>
