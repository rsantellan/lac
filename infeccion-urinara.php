...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-infeccion-urinaria.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de infección urinaria';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Infección urinaria</title>
<meta name="keywords" content="examen de orina, infección urinaria" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'infeccion-urinara';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>ESTUDIO DE LA INFECCIÓN URINARIA</h1>
									<span class="prueba">UROCULTIVO</span>
								</div>
								<img src="images/resources/landings/infeccion-urinaria.jpg" alt="infección urinaria" title="infección urinaria">
							</div><!-- single post image -->
							<p>Realizamos una prueba de tamizaje de cultivo de orina con metodología Laser / Turbidimetría en plataforma Alfred 60 – Allifax.</p>
							<p>Si recibimos la muestra en la mañana, en esa misma tarde a la hora 18:00 le indicamos la existencia o no de infección urinaria; en caso de que la muestra presente elementos de infección urinaria se procede a investigar en forma convencional (automatizada con plataforma WalkAway / Beckman Coulter) la sensibilidad e identificación del germen.</p>

							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar su examen de infección urinaria</p>
								</div>
