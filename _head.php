...
<head>
	...
	<!--SCRIPTS-->
		...
		<!-- <script type="text/javascript" src="js/jquery.counterup.min.js"></script>for funfacts -->
        <script type="text/javascript" src="js/perfect-scrollbar.jquery.min.js"></script><!-- perfact scrollbar -->
        <script type="text/javascript" src="js/perfect-scrollbar.min.js"></script><!-- perfact scrollbar -->
        <script type="text/javascript" src="js/script.js"></script>
		<script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script><!-- for funfacts counter -->
