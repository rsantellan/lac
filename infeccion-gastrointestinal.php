...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-infeccion-gastrointestinal.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de infección gastrointestinal';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Investigación de infecciones gastrointestinales</title>
<meta name="keywords" content="infección gastrointestinal, infecciones gastrointestinales" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'infeccion-gastrointestinal';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>INVESTIGACIÓN DE INFECCIONES GASTROINTESTINALES</h1>
									<span class="prueba">PANEL GASTROINTESTINAL (22 AGENTES) DETERMINACIÓN EN MATERIA FECAL</span>
								</div>
								<img src="images/resources/landings/infeccion-gastrointestinal.jpg" alt="infecciones gastrointestinales" title="infecciones gastrointestinales">
							</div><!-- single post image -->
							<p>Realizamos el estudio de 22 agentes de infección gastrointestinal por metodología de Biología Molecular (PCR) en plataforma FilmArray/ Biofire / Biomerieux. (Agentes: CAMPYLOBACTER (JEJUNI, COLI AND UPSALIENSIS), CLOSTRIDIUM DIFFICILE (TOXIN A/B), PLESIOMONAS SHIGELLOIDES, SALMONELLA, YERSINIA ENTEROCOLITICA, VIBRIO (PARAHAEMOLYTICUS, VULNIFICUS).</br>VIBRIO CHOLERAE, ENTEROAGGREGATIVE E. COLI (EAEC), ENTEROPATHOGENIC E. COLI (EPEC), ENTEROTOXIGENIC E. COLI (ETEC) LT/ST, SHIGA-LIKE TOXIN-PRODUCING E. COLI (STEC) STX1/STX2, E. COLI O157, CRYPTOSPORIDIUM, CYCLOSPORA CAYETANENSIS, ENTAMOEBA HISTOLYTICA, GIARDIA LAMBLIA, ADENOVIRUS F 40/41, ASTROVIRUS, NOROVIRUS GI/GII, ROTAVIRUS A, SAPOVIRUS (I, II, IV AND V), COMENTARIO PGI, SHIGELLA/ENTEROINVASIVE E. COLI (EIEC)</p>
							...
							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									...
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el examen de infecciones gastrointestinales</p>
								</div>
