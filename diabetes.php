...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-diabetes.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para valoración y diagnóstico de la diabetes';        
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Valoración & diagnóstico de la diabates</title>
<meta name="keywords" content="diabetes, insulina, glucosa, hemoglobina glicosidada, metabolismo lipídico" />
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>VALORACIÓN & DIAGNÓSTICO DE LA DIABETES</h1>
									<span class="prueba">INSULINA DETERMINACIÓN EN SUERO</br>GLUCOSA DETERMINACIÓN EN SANGRE</span>
								</div>
								<img src="images/resources/landings/diabetes.jpg" alt="diabetes" title="diabetes">
							</div><!-- single post image -->
							<p>La diabetes es una enfermedad crónica en la cual el cuerpo no puede regular la cantidad de azúcar en la sangre. Cualquier persona que tenga síntomas de diabetes debe ser examinada para detectar la enfermedad. Algunas personas no tendrán síntomas, pero pueden tener factores de riesgo para diabetes y deben ser examinadas. Las pruebas les permiten a los profesionales de la salud detectar la diabetes más temprano y trabajar con sus pacientes para manejar la enfermedad y prevenir sus complicaciones.</p>
							<p>Realizamos ambos estudios en plataforma Architect – Abbott.</br>Se extrae una muestra de sangre del paciente en ayunas y en 60 minutos le devolvemos el resultado.</p>

							<div class="post-avatar" style="margin-top:20px;">
								<div class="news-detail" style="padding-bottom:0">
									<h1>VALORACIÓN & DIAGNÓSTICO DE LA DIABETES</h1>
									<span class="prueba">HEMOGLOBINA GLICOSILADA DETERMINACIÓN EN SANGRE</span>
								</div>
							</div><!-- single post image -->
							<p>Realizamos el estudio de la Hemoglobina glicosilada en forma cuantitativa por metodología de HPLC / Variant II / Biorad.</p>
							<p>Se extrae una muestra de sangre del paciente en la mañana y a la hora 19:00 le devolvemos el resultado.</p>

							<div class="post-avatar" style="margin-top:20px;">
								<div class="news-detail" style="padding-bottom:0">
									<h1>VALORACIÓN DEL METABOLISMO LIPÍDICO</h1>
									<span class="prueba">PEFIL LIPÍDICO <span style="text-transform:none">(Colesterol, HDL Colesterol, LDL Colesterol, índices de riesgo, Triglicéridos)</span></span>
								</div>
							</div><!-- single post image -->
							...
							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									...
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar su examen de valoración hormonal en la mujer</p>
								</div>
