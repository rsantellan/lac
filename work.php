...
$secretKey	 = '6LdJShcUAAAAAM_qtkFwf4FvvdyzPs1DGjIrshNb';
...
$e_body			 = "Ud ha sido contactado por $name, Su mensaje es el siguiente." . PHP_EOL . PHP_EOL;
$e_content		 = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply		 = "Ud puede contactarse con $name via email a $email o via telefónica a $telefono";
...
if ( mail( $address, $e_subject, $message, $headers) ) {
    ...
    echo "<p>Gracias<strong>$name</strong>, su mensaje fue enviado correctamente. Nos podremos en contaco a la brevedad.</p>";
    echo "</div>";
