...
<body>
	<table cellpadding="0" cellspacing="0" style="width:800px; margin:25px 0;">
        ...
        <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#353535; fext-align:left">Ud ha sido contactado por <span style="color:#a12457"><?php echo $name;?></span>para un examen de meningitis</td>
        </tr>
       <tr>
