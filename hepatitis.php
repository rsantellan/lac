...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-hepatitis.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de heptitis infecciosa A-B-C';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Pruebas vinculadas a la hepatitis infecciosa A-B-C</title>
<meta name="keywords" content="Hepatitis, Hepatitis A, Hepatitis B, Hepatitis C" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'hepatitis';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>PRUEBAS VINCUALDAS A LA HEPATITIS INFECCIOSA A-B-C</h1>
									<span class="prueba">MARCADORES DE HEPATITIS A-B-C</span>
								</div>
								<img src="images/resources/landings/hepatitis.jpg" alt="hepatitis" title="hepatitis">
							</div><!-- single post image -->
							<p>Realizamos el estudio de los marcadores de hepatitis A-B-C por metodología de quimioluminiscencia en plataforma Architect – ABBOTT.</p>
							<p>Se extrae una muestra de sangre de la paciente en ayunas y en 120 minutos le devolvemos el resultado.</p>


							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el examen de hepatitis infecciosa</p>
								</div>
