...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-infeccion-respiratoria.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de infección respiratoria';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Investigación de infecciones respiratorias</title>
<meta name="keywords" content="infección respiratoria, infecciones respiratorias" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'infeccion-respiratoria';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>INVESTIGACIÓN DE INFECCIONES RESPIRATORIAS</h1>
									<span class="prueba">PANEL RESPIRATORIO (20 AGENTES) EN HISOPADO NASO-FARÍNGEO</span>
								</div>
								<img src="images/resources/landings/infeccion-respiratoria.jpg" alt="infecciones respiratorias" title="infecciones respiratorias">
							</div><!-- single post image -->
							<p>Realizamos el estudio de 20 agentes de infección respiratoria por metodología de Biología Molecular (PCR) en plataforma FilmArray/ Biofire / Biomerieux. (Agentes: ADENOVIRUS, CORONAVIRUS 229E, CORONAVIRUS NL63, CORONAVIRUS OC43, METANEUMOVIRUS HUMANO, INFLUENZA A, PARAINFLUENZA VIRUS 1, INFLUENZA B, PARAINFLUENZA VIRUS 2, PARAINFLUENZA VIRUS 3, PARAINFLUENZA VIRUS 4, VIRUS RESPIRATORIO SINCICIAL, BORDETELLA PERTUSSIS, CHLAMYDOPHILA PNEUMONIAE, MYCOPLASMA PNEUMONIAE, CORONAVIRUS HKU1, RHINOVIRUS / ENTEROVIRUS HUMANO). </p>
							<p>Luego de la toma de la muestra le devolvemos el resultado en 70 minutos.</p>

							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el examen de infecciones respiratorias</p>
								</div>
