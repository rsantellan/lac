		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="menubar">
						<div class="logo">
							<h1><a href="index.php" title=""><img src="images/logo-1.png" alt="LAC"></a></h1>
						</div>
						<nav>
							<div class="main-menu">
								<ul>
	...
	<div class="responsive-menu">
		...
		<div class="res-head">
			<div class="res-logo">
				<a href="#" title=""><img src="images/responsive-logo.png" alt="LAC"></a>
			</div>
		...
		<div class="res-menu-dropdown">
        	...
        	<div class="logo"><a href="#" title=""><img src="images/responsive-logo.png" alt="LAC"></a></div>
			<ul class="dropdown">
				<li class="has-dropdown"><a href="index.php" title="" <?php if($pagina == 'inicio'):?> class="current"<?php endif;?>>inicio</a></li>
				<li class="has-dropdown"><a href="quienes-somos.php" title="" <?php if($pagina == 'quienes_somos'):?> class="current"<?php endif;?>>qui&eacute;nes somos</a></li>
				<li class="has-dropdown"><a href="panorama.php" title="" <?php if($paginainicial == 'pruebas'):?> class="current"<?php endif;?>>pruebas</a></li>
				...
				<li class="has-dropdown"><a href="instituciones-medicos.php" title="" <?php if($pagina == 'instituciones_medicos'):?> class="current"<?php endif;?>>instituciones y m&eacute;dicos</a></li>
				<li><a href="pacientes.php" title="" <?php if($pagina == 'pacientes'):?> class="current"<?php endif;?>>pacientes</a></li>
				<li><a href="contacto.php" title="" <?php if($pagina == 'contacto'):?> class="current"<?php endif;?>>contacto</a></li>
			</ul>
			<div class="responsive-menu-footer">
				<span><i class="fa fa-clock-o"></i> Horario:</span>
                <i>L a V: 07:30-21:30 - Sáb: 08:00-15:00</i>
			</div>
		</div>
	</div><!-- responsive menu -->