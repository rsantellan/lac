...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-anticoagulantes.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de valoración de la anticoagulación oral';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Valoración de la anticoagulación oral</title>
<meta name="keywords" content="anticoagulación oral, anticoagulantes" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'anticoagulantes';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>VALORACIÓN DE LA ANTICOAGULACIÓN ORAL</h1>
									<span class="prueba">PROTROMBINA TIEMPO DE (CON INR) DETERMINACIÓN EN PLASMA</span>
								</div>
								<img src="images/resources/landings/anticoagulantes.jpg" alt="anticoagulantes" title="anticoagulantes">
							</div><!-- single post image -->
							<p>La prueba está fundamentalmente dirigida a quienes toman Anticoagulantes Orales, no para el público en general.</p>
							<p>Tiempo de Protrombina (TP) y Ratio Internacional Normalizada (INR) son pruebas que se utilizan para evaluar conjuntamente con el Tiempo de Tromboplastina Parcial Activado (APTT) para la evaluación de la coagulación.</p>
							<p>Realizamos el estudio del Tiempo de Protrombina en plataforma ACL 300.</br>Se extrae una muestra de sangre del paciente y en 60 minutos le devolvemos el resultado.</p>

							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el examen de valoración de anticoagulación oral</p>
								</div>
