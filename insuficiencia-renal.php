...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-insuficiencia-renal.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para valoración renal';      
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Valoración renal</title>
<meta name="keywords" content="insuficiencia renal, valoración renal" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'insuficiencia-renal';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>VALORACIÓN DE LA FUNCIÓN RENAL</h1>
									<span class="prueba">PROTEINURIA - ALBUMINURIA DETERMINACIÓN <span style="text-transform:none">(Incluye la determinación de Proteínas en orina, Albúmina en orina, Creatinina en orina, Filtrado Glomerular Renal)</span></br>UREA DETERMINACIÓN EN SUERO</br>CREATININA DETERMINACIÓN EN SUERO</br>IONOGRAMA DETERMINACIÓN EN SUERO</span>
								</div>
								<img src="images/resources/landings/valoracion-renal.jpg" alt="insuficiencia renal" title="insuficiencia renal">
							</div><!-- single post image -->
							<p>Entre otras funciones, los riñones eliminan toxinas, desechos metabólicos y exceso de iones de la sangre que sale del cuerpo en la forma de orina. Existen distintas pruebas de laboratorio que evalúan la funcionalidad renal.</p>
							<p>Realizamos el estudio en plataforma Architect – Abbott.</br>Se extrae una muestra de sangre del paciente en ayunas y en 60 minutos le devolvemos el resultado.</p>


							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar su examen de valoración renal</p>
								</div>
