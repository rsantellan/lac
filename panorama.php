    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        if($result > 0){
          ...
          $msg .= '<div class="alert alert-danger">Ha ocurrido un error. Por favor intente nuevamente en unos minutos</div>';
            $err = 1;
        }
      }
    }  
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Screening prenatal</title>
<meta name="keywords" content="screening prenatal, trisomia 21" />
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>SCREENING PRE-NATAL NO INVASIVO PANORAMA®</h1>
									<span class="prueba">TRISOMÍA 21-18-13 / MONOSOMIA X / TRIPLOIDÍA / SÍNDROME DE DELECIÓN 22Q11.2 / REPORTE DE GÉNERO (SEXO) SI EL PACIENTE LO DESEA.</span>
								</div>
								<img src="images/resources/landings/panorama.jpg" alt="panorama" title="panorama">
							</div><!-- single post image -->
							<p>Tamizaje prenatal no invasivo del ADN para detectar anormalidades comunes en los cromosomas del feto</p>
							
							<div class="post-avatar" style="margin-top:20px;">
								<div class="news-detail" style="padding-bottom:0">
									<h1>SCREENING PRE-NATAL NO INVASIVO PANORAMA® - PRUEBA EXTENDIDA</h1>
									<span class="prueba">TRISOMÍA 21-18-13 / MONOSOMIA X / TRIPLOIDÍA / SÍNDROME DE DELECIÓN 22Q11.2 / Síndrome de deleción 1p36 / Síndrome de Angelman / Síndrome de Cri-du-chat / Síndrome de Prader -Will / REPORTE DE GÉNERO (SEXO) SI EL PACIENTE LO DESEA.</span>
								</div>
							</div><!-- single post image -->
							...
							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									...
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar el screening prenatal</p>
								</div>
