...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-examen-orina.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para examen de orina completa';  
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Exmamen de orina</title>
<meta name="keywords" content="examen de orina, orina" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'examen-de-orina';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>EXAMEN DE ORINA COMPLETA</h1>
								</div>
								<img src="images/resources/landings/examen-orina.jpg" alt="examen de orina" title="examen de orina">
							</div><!-- single post image -->
							<p>Realizamos el estudio de orina por metodología de química seca en plataforma automatizada Atlas / Novus / Siemens.</p>
							<p>Luego de recibir la muestra le devolvemos el resultado en 30 minutos.</p>

							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar su examen de orina</p>
								</div>
