...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-valoracion-tiroidea.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para valoración de la función tiroidea';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Valoración de la función tiroidea</title>
<meta name="keywords" content="Hipotiroidismo, Hipertiroidismo, TSH, BOCIO, Graves, T4, FT4, T3, FT3, Tiroides, Triodotironina, Tiroxina" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'hipotiroidismo-hipertiroidismo';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>VALORACIÓN DE LA FUNCIÓN TIROIDEA</h1>
									<span class="prueba">TSH-TIROTROFINA DETERMINACIÓN EN SUERO</br>T3 LIBRE TRIIODOTIRONINA LIBRE DETERMINACIÓN EN SUERO</br>T4 LIBRE TIROXINA DETERMINACIÓN EN SUERO</br>TIROIDEOS ANTICUERPOS ANTI (ATA) DETERMINACIÓN EN SUERO</span>
								</div>
								<img src="images/resources/landings/valoracion-tiroidea.jpg" alt="Hipotiroidismo-Hipertiroidismo" title="Hipotiroidismo-Hipertiroidismo">
							</div><!-- single post image -->
							<p>Las pruebas de función tiroidea verifican cómo su tiroides está funcionando. También se usan para diagnosticar, controlar y ayudar a encontrar la causa de enfermedades de la tiroides, incluyendo el hipertiroidismo y el hipotiroidismo.</p>
							<p>Realizamos el estudio de la hormona TSH, T3 LIBRE y T4 LIBRE en forma cuantitativa por metodología de quimioluminiscencia en plataforma Architect – ABBOTT.</br>Se extrae una muestra de sangre del paciente en ayunas y en 60 minutos le devolvemos el resultado.</p>
							<p><strong>Información de interés:</strong></br>
								<a href="http://aetiroides.com" target="blank">Asociación Española de la Tiroides</a></br>
								<a href="https://www.thyroid.org/thyroid-information/" target="blank">American Thyroid Association</a>
							</p>
							<div class="lab-features" style="margin-bottom:40px;">
								<div class="heading4">
									<h4>Solicitar<ins> hora</ins></h4>
									<p>Complete el formulario con sus datos y nos pondremos en contacto a la brevedad para coordinar su examen de valoración de la función tiroidea</p>
								</div>
