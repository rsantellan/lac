...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($captcha_success->success==false) {
      ...
      if($err == 0){
        ...
        ob_start();
        include ('mail-fertilidad.php');
        $messageBody = ob_get_clean();
        $from = 'acliente@lac.com.uy';
        $address = "acliente@lac.com.uy";
        $e_subject = 'Solicitud de hora para valoración hormonal en la mujer';
        // Create the message
...
<!DOCTYPE html>
<html lang="es">
<title>Laboratorio de An&aacute;lisis Cl&iacute;nicos | Valoración hormonal en la mujer</title>
<meta name="keywords" content="Fertilidad, Reserva Ovárica, Valoración hormonal de la fertilidad, FSH, LH, antimulleriana, Foliculo estimulantes" />
<?php $paginainicial = 'pruebas';?>
<?php $pagina = 'fertilidad';?>
						...
						<div class="blog-single-meta">
							<div class="post-avatar">
								<div class="news-detail">
									<h1>VALORACIÓN HORMONAL EN LA MUJER</h1>
									<span class="prueba">FSH-HORMONA FOLICULO ESTIMULANTE DETERMINACIÓN EN SUERO</br>LH-HORMONA LUTEINIZANTE DETERMINACIÓN EN SUERO</br>PROGESTERONA HORMONA DETERMINACIÓN EN SUERO</br>TESTOSTERONA LIBRE DETERMINACIÓN EN SUERO</br>MH HORMONA ANTI MULLERIANA DETERMIANCIÓN EN SUERO</span>
								</div>
								<img src="images/resources/landings/fertilidad.jpg" alt="fertilidad" title="fertilidad">
							</div><!-- single post image -->
							<p>El examen hormonal se realiza para estudiar el nivel de las hormonas femeninas encargadas de regular el ciclo ovárico y poder determinar así su influencia en la fertilidad. Las principales hormonas que se analizan son: progesterona, FSH, LH, y antimulleriana.</p>
							<p>Realizamos el estudio de estas hormonas en forma cuantitativa por metodología de quimioluminiscencia en plataforma Architect – ABBOTT.</p>
							<p>Se extrae una muestra de sangre del paciente en ayunas y en 120 minutos le devolvemos el resultado.</p>
							<p>La hormona anti mulleriana no se puede hacer de urgencia tardamos 7 días.</p>
